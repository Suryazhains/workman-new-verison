    ...
    <>
      ...
      >
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 mb-10">
          {/* UPDATED: Color changed to Green #51A147 */}
          <h2 className="font-bold text-3xl md:text-[40px] text-[#51A147] mb-4">
            {portfolio.heading}
          </h2>
      ...
      >
        <div className="max-w-[1440px] mx-auto">
          {/* Heading */}
          {/* UPDATED: Color changed to Green #51A147 */}
          <h2 className="text-[32px] md:text-[40px] font-bold text-[#51A147] mb-4">
